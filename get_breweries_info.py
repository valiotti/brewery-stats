...
for brewery_id in brewery_ids:
    ...
    data_to_insert_in_brewery_info.append(item['response']['brewery']['location']['brewery_city'])
    ...
    data_to_insert_in_brewery_info.append(item['response']['brewery']['brewery_description'].replace("'", ""))
